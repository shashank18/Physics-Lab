...
public class Graph_estimate_settings extends View 
    implements ChartChangeListener, ChartProgressListener{
    
    /** The user interface thread handler. */
    private Handler mHandler;

    public Graph_estimate_settings(Context context) {
        super(context);
        mHandler = new Handler();
        this.initialize();
    }
    
    public Graph_estimate_settings(Context context, AttributeSet attrs) {
        super(context, attrs);
        mHandler = new Handler();
        this.initialize();
    }
