...
public class Graph_diode_settings extends View 
    implements ChartChangeListener, ChartProgressListener{
    
    /** The user interface thread handler. */
    private Handler mHandler;

    public Graph_diode_settings(Context context) {
        super(context);
        mHandler = new Handler();
        this.initialize();
    }
    
    public Graph_diode_settings(Context context, AttributeSet attrs) {
        super(context, attrs);
        mHandler = new Handler();
        this.initialize();
    }
